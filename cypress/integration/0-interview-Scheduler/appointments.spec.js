describe("appointment", () => {
  ...
  it("should book an interview", () => {
    ...
    window.cy.get("[alt=Add]")
    .first()
    .click();
    //2: Enter a student name 
    window.cy.get("[data-testid=student-name-input]").type("Lydia Miller-Jones");
  ...
  it("should edit an interview", () => {
    ...
    window.cy.get("[alt=Edit]")
    .first()
    .click({ force: true });
    //2: Delete and then enter a student name
    window.cy.get("[data-testid=student-name-input]")
    .clear()
    .type("Sayantan Basu") ;
  ...
  it("should cancel an interview", () => {
    ...
    window.cy.contains(".appointment__card--show", "Archie Cohen")
      .should("not.exist");
